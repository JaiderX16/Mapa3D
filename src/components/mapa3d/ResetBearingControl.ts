 ...
 * and flat in a single click.
 *
 * The button is active the moment the view is rotated or tilted, showing a red, 
 * rotating compass needle that tracks the live bearing.
 */
